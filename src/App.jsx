...
const App = () => {
  ...
  const saveRes = async (e) => {
    ...
    const d = { ...formData, isUrssaf: formData.isUrssaf !== false, grossAmount: g, netAmount: n, platformFees: plat, bankFees: bank, cityTax: city, displayedAmount: disp, acompte1Amount: a1, a2, soldeAmount: s, resExpenses: (formData.resExpenses || []).map(r => ({ ...r, amount: parseFloat(r.amount) || 0, hoursEntry: parseFloat(r.hoursEntry) || 0, rateEntry: parseFloat(r.rateEntry) || 0, hoursExit: parseFloat(r.hoursExit) || 0, rateExit: parseFloat(r.rateExit) || 0 })) };
  ...
  const startReview = () => { /* Logique d'analyse CSV simplifiée ici */ };
  const confirmImport = async () => { /* Logique d'import simplifiée ici */ };
