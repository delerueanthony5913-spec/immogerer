...
import { 
  ...
  LocateFixed, Lock, Mail, Copy, Link
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row font-sans text-slate-900">
      ...
      <main className="flex-1 w-full min-w-0 min-h-screen relative flex flex-col overflow-x-hidden">
        ...
        <div ref={scrollContainerRef} onScroll={handleScroll} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd} className="flex-1 w-full flex overflow-x-auto snap-x snap-mandatory hide-scroll">
